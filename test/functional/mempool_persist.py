...
By default, cesarcoind will dump mempool on shutdown and
...
class MempoolPersistTest(CesarcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(1)
        self.start_node(2)
        # Give cesarcoind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent cesarcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
