...
# TestNode: A peer we use to send messages to cesarcoind, and store responses.
...
class CompactBlocksTest(CesarcoinTestFramework):
    ...
    # This test actually causes cesarcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that cesarcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for cesarcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # cesarcoind will not send blocktxn responses for blocks whose height is
