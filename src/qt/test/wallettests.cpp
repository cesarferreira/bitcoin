...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<CesarcoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_cesarcoin-qt -platform xcb      # Linux
//     src/qt/test/test_cesarcoin-qt -platform windows  # Windows
//     src/qt/test/test_cesarcoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = CesarcoinUnits::formatWithUnit(unit, balance, false, CesarcoinUnits::separatorAlways);
    ...
    // Amount input
    CesarcoinAmountField* amountInput = receiveCoinsDialog.findChild<CesarcoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: cesarcoin:")) != -1);
