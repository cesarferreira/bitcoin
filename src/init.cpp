 ...
 * between cesarcoind, and cesarcoin-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("cesarcoin-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/cesarcoin/cesarcoin>";
    const std::string URL_WEBSITE = "<https://cesarcoincore.org>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("cesarcoin-loadblk");
...
/** Sanity checks
 *  Ensure that Cesarcoin is running in a usable environment with all
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single Cesarcoin process is using the data directory.
