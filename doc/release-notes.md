...
Cesarcoin Core version *version* is now available from:

  <https://cesarcoin.org/bin/cesarcoin-core-*version*/>
...
GCC 4.8.x
--------------
The minimum version of GCC required to compile Cesarcoin Core is now 4.8. No effort will be
