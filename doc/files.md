...
* cesarcoin.conf: contains configuration settings for cesarcoind or cesarcoin-qt
* cesarcoind.pid: stores the process id of cesarcoind while running
...
* debug.log: contains debug information and general logging generated by cesarcoind or cesarcoin-qt
