...
This document provides guidelines for internationalization of the Cesarcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `cesarcoin_en.ts` remains unchanged.
