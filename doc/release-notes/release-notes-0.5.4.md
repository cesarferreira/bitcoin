Cesarcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/cesarcoin/files/Cesarcoin/cesarcoin-0.5.4/
...
http://gitorious.org/cesarcoin/cesarcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Cesarcoin-Qt notifications under Growl 1.3.
Increase required age of Cesarcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCesarcoin properly when installing Cesarcoin-Qt over it. (Windows)
