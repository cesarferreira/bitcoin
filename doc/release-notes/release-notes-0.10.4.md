Cesarcoin Core version 0.10.4 is now available from:

  <https://cesarcoin.org/bin/cesarcoin-core-0.10.4/>
...
- #6953 `43c2789` Split cesarcoin-tx into its own package
- #6953 `dfe0d4d` Include cesarcoin-tx binary on Debian/Ubuntu
