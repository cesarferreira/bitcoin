Cesarcoin Core version *0.15.0.1* is now available from:

  <https://cesarcoin.org/bin/cesarcoin-core-0.15.0.1/>

and

  <https://cesarcoincore.org/bin/cesarcoin-core-0.15.0.1/>
