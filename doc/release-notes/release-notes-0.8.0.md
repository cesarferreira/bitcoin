Cesarcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/cesarcoin/files/Cesarcoin/cesarcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Cesarcoin
...
New/changed settings (command-line or cesarcoin.conf file)
--------------------------------------------------------
